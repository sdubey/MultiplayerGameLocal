 ...
 * @author Gary
 */
public final class SpeciesCSVDAO {

    private SpeciesCSVDAO() {
    }
    ...
    public static void createCSV(String manipulation_id, String csv) throws SQLException {
        ...
        try {
            String query_1 = "SELECT * FROM `species_csv` WHERE `manipulation_id` = ?";
            ...
            if (!rs.next()) {
                ...
                String query_2 = "INSERT INTO `species_csv` (`manipulation_id`, `csv`) VALUES (?, ?)";
                ...
                String query_3 = "UPDATE `species_csv` SET `csv` = ? WHERE `manipulation_id` = ?";
    ...
    public static String getCSV(String manipulation_id) throws SQLException {
        ...
        String query = "SELECT * FROM `species_csv` WHERE `manipulation_id` = ?";
